            ...
            <div className="landing-card bg-gradient-to-br from-green-900/40 to-green-800/30 border-green-700/50">
              ...
              <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/60 rounded-2xl p-4 mb-6 border border-gray-700/30 backdrop-blur-xl">
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-green-400/30 to-green-300/20 flex items-center justify-center flex-shrink-0">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="landing-card">
              <div className="text-center">
                <div className="feature-icon w-20 h-20 mx-auto mb-6">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="section-title mb-6">
              Privacy <span className="text-[#FDDA24]">Withdraw</span>
            </h1>
          ...
          <div className="landing-card mb-6">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-5xl font-bold hero-headline mb-2">100 XLM</p>
            </div>
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                rows={4}
                className={`w-full bg-gradient-to-br from-gray-900/80 to-gray-800/60 border rounded-2xl px-6 py-4 text-white placeholder-gray-500 focus:outline-none transition-all duration-300 font-mono text-sm backdrop-blur-sm ${
                  noteInput.trim()
                    ? noteValid === true && !noteSpent
                      ? "border-green-500 focus:border-green-400 shadow-md shadow-green-500/20"
                      : noteValid === false || noteSpent
                        ? "border-red-500 focus:border-red-400 shadow-md shadow-red-500/20"
                        : "border-gray-700 focus:border-[#FDDA24] shadow-md shadow-[#FDDA24]/20"
                    : "border-gray-700 focus:border-[#FDDA24] shadow-md shadow-[#FDDA24]/20"
                }`}
              />
            ...
            {/* Info Box */}
            <div className="bg-gradient-to-br from-purple-900/40 to-purple-800/20 border border-purple-700/30 rounded-2xl p-4 mb-6 backdrop-blur-sm">
              <div className="flex items-start space-x-3">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-purple-400/30 to-purple-300/20 flex items-center justify-center flex-shrink-0">
            ...
            <button
              ...
              className="w-full landing-btn-primary landing-btn-cta py-6 px-8 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="landing-card p-6">
              ...
              <h3 className="font-bold text-white mb-2">Unlinkable</h3>
            ...
            <div className="landing-card p-6">
              ...
              <h3 className="font-bold text-white mb-2">Verifiable</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
            ...
            <div className="landing-card p-6">
              ...
              <h3 className="font-bold text-white mb-2">Client-side</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
